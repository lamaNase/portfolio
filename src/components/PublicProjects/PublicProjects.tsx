...
import taskApp from "./task_management_app.png";
import quizApp from "./auth_quiz_ranker.png";
import dataViz from "./auto_data_viz.png";
import arabicSummarizer from "./arabic_text_summarizer.png";
